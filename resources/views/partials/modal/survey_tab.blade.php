...
<div class="row">
    <div class="col-sm-12" style="border: solid 1px #dee2e6;margin-top: 0px;min-height: 400px;">
<div class="row">
    <div class="col-sm-12 pl-0 pr-0">
        <div class="trow_" style="background-color: #f2f2f2; padding: 14px 0px;">
                <h4 class="wd-100p cnt-center fs-24_ weight_600" style="color: #3b7ec4;margin-bottom: 3px !important;">Where would you like to begin?</h4>
        </div>
    </div>
</div>
