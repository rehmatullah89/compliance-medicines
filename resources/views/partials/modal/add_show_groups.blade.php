  ...
  <div class="modal-dialog wd-87p-max_w_700">
    <div class="modal-content compliance-form_">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
            <!-- group user <div id="group-reg-step" class="tab-content current"> -->
                       <!-- <h4>Group Detail</h4> -->
                       <!-- <section class="row"> -->
                ...
                <div class="flds-cty-st-zp flx-justify-start mb-14_">
                  <div class="wd-19p field fld-zip mr-1p">
                    ...
                    <input class="wd-100p" type="text" placeholder="Enter Zip" name="zip" minlength="5" maxlength="10" mask="00000-0000">
                  </div>
          ...
          <!-- </section> -->
            <!-- <h4>Users</h4>
                        <section class="row">
                          <div class="col-sm-12 pl-0 pr-0">
                        <div class="col-sm-12 primary_site_group pl-0 pr-0" id="primary_group">
                          ...
                          <div class="wd-25p field field-modal fld-bnk_ac_no">
                            <label class="wd-100p">Site Role</label>
                              ...
                              <div class="flx-justify-start mb-14_">
                                    <div class="btn bg-blue-txt-wht" style="text-align:right;padding: 5px 7px;line-height: 17px;" onclick="add_row_group()">Add <i  class="fa fa-plus-circle"></i></div>
                                </div>
                          </div>
