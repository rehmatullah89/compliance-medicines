                        ...
                        <form class="compliance-form_ trow_" method="post" action="{{ url('roles/'.$data->id) }}" id="m_form_1">
                            ...
                            <div class="flds_name flx-justify-start mb-14_">
          						<div class="wd-70p field fld-perm_name mr-1p">
          							...
          							<input type="text" class="wd-100p" name="name" required placeholder="Enter module name" value="{{$data->name}}" maxlength="30">
                            ...
                            <div class="trow_ table-responsive-1024 table-responsive">
                                <table id="roles_create-edit_table" class="table table-bordered " style="width: 100%;">
                                    ...
                                    <tr class="weight_500-force-childs bg-blue">
                                        <th class="txt-wht" style="width:100px;"><input type="checkbox" id="select-all">Modules</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="module_td">
                                            	<input type="checkbox" class="module" id="{{ $module->id }}"> {{ $module->name }}
                                            </td>
                                            <td>
                            ...
                            <div class="trow_ mt-7_ cnt-left">
                                <button type="button"  class="btn btn-xs btn-danger" onclick="window.location='{{ url("/roles") }}'">Cancel</button>&nbsp;
