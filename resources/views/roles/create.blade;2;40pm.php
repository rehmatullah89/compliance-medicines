...
@section('content')
    <style>
		...
		#roles_create-edit_table thead th.module_td {  }
		...
		#roles_create-edit_table tbody td.module_td input[type="checkbox"] + label { line-height: 1.4em; text-transform: uppercase; color: #242424; cursor: pointer; }
		...
		#roles_create-edit_table tbody td.permission-list div.permission { margin-bottom: 5px; cursor: pointer; }
		...
		#roles_create-edit_table tbody td.permission-list div.permission input[type="checkbox"] + span { line-height: 1.4em; text-transform: uppercase; }
		#roles_create-edit_table tbody td.permission-list div.permission input[type="checkbox"] + label { line-height: 1.4em; text-transform: uppercase; color: #242424; cursor: pointer;}
    			...
    			<div class="col-sm-12">
    				...
    				<div class="trow_" id="patient_data">
                        ...
                        <form class="compliance-form_ trow_" method="post" action="{{url('roles')}}" id="m_form_1">
                            ...
                            <div class="wd-70p field fld-perm_name mr-1p">
                                <span class="wd-100p txt-gray-6" style="margin-bottom: 10px;">Login access for </span><br/>
                                                                <input type="radio" id="all_access" name="permission[]" value="46" checked="" style="height:10px;">
                                                                <label for="all_access">All Access</label>
                                                                <input type="radio" id="practice_admin" name="permission[]" value="47" style="height:10px;">
                                                                <label for="practice_admin">Practice Admin</label><br>
                                                        </div>
