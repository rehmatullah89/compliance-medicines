...
<div class="pos-abs_ " style="top: 0px; max-width: 325px; height: auto; display: block;/* margin: 40px auto; */">
	<div class="trow pa-c-14-0 fs-13-force-child_" style="background-color:  #d9d9d9; padding: 10px; display: inline-block;width: 100%;font-size: 13px;">
			...
			<div  style="float: left;font-family: Arial;" id="date_created">{{date("m/d/Y",strtotime(@$createdAt[0]))}}</div>
                        <div style="float: right;font-family: 'Arial', sans-serif;" id="time_created">{{date("H:i",strtotime(@$createdAt[1]))}}</div>
		</div><br/>
		...
		<div class="trow fs-zero mt-7" style="margin-bottom: 7px; margin-top: 5px; height:0px; border: dashed 1px #3e7bc4;"></div>
			...
			<div  style="float: right; font-weight: 500;" class="wd-70px cnt-right pr-3_">$ <?=number_format($RxPatientOutOfPocket,2)?></div>
		</div><br/><br/>
                <!-- <div  style="display: inline-block; width: 100%;  margin-bottom: 4px;">
		...
		<!--<div  style="display: inline-block; width: 100%;  margin-bottom: 4px;">
			...
			<div style="border-top: solid 1px #242424; float: right; font-weight: 700;" id="rx_sale_2" class="wd-70px pt-2_ pr-3_">$ <?=number_format($RxPatientOutOfPocket,2)?></div>
		</div><br/>
