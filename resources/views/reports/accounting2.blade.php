...
<div id="search_screen" class="row pos-rel_"
	style="padding-right: 314px; padding-right: 400px; min-height: 480px; margin-bottom: 24px; display: none;">
	<div class="col-sm-12 pr-0">
		<div class="row">
			<div class="col-sm-12">
				<div class="row">
					<div class="col-sm-12">
						<div class="trow_ flx-justify-start f-wrap ">
							<div class="wd-100p bg-gray-2 pa-14_ mr-14-100p_ mb-17_"
								style="max-width: 330px; max-width: 48%;">
								<div class="trow_ txt-blue weight_600 cnt-center mb-7_">BEST
									MATCH (ES) choose</div>
								<div id="matches_list"></div>
							</div>
							<!-- <div id="invoice_screen1"
								class="wd-100p pa-14_ txt-gray-6 mb-17_"
								style="max-width: 330px; max-width: 48%; border: solid 1px #d3dee5; display: none;">
    ...
    <div id="screen2_dub" class="wd-87p-max_w_400 pos-abs_" style="display:none; right: 40px;">
        <form action="{{ url('orders') }}" name="order_form_check" method="post">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-sm-12">

                    <div class="trow_ cnt-center c-dib_ mb-14_">
                        <span class="txt-red weight_600 fs-24_ tt_uc_"></span>
                        <span class="txt-red weight_600 fs-24_ tt_uc_" style="margin-left: 5px">
                            <span class="txt-red weight_600 fs-24_" style="text-transform: none;">Rx </span>Not Paid yet <br>by Patient
                        </span>
                    </div>
                </div>
            </div>
            <input type="hidden" name="keyword" id="str_keyword" value="" />
            <div class="flx-justify-center wd-100p pb-14_">
                <input type="hidden" name="outside_link" id="outside_link" value="" />
                <button type="submit" class="btn bg-blue-txt-wht weight_500 fs-14_ tt_uc_ ml-14_ ">check detail ></button>
            </div>
        </form>
    </div>

	<div id="invoice_screen2" class="pos-abs_ " style="top: -54px; right: 40px; width: 350px; height: 100%;">
		...
		<div class="trow_ bg-gray-d9 pa-c-14-0_ pt-14_ fs-13-force-child_">
			...
			<div class="trow_ mb-2_ c-dib_ cnt-center">
				<div class="cnt-left fs-16_ mb-3_ mr-4_ weight_600"
					id="pharmacy_name">OLYMPUS Rx</div>
			...
			<div class="trow_ mb-2_">
				<div class="trow_ c-dib_ cnt-center fs-16_ weight_500">
					<span class="mr-4_" id="practice_address">house123 test</span> <span
						class=" cnt-left fs-13_ mb-3_ weight_500 tt_uc_"
						id="pharmacy_address">LEWISVILLE, CA 48188-5</span>
				</div>
			</div>

			<div class="trow_ c-dib_ cnt-center">
				<div class="cnt-left fs-16_ mb-3_ mr-4_ weight_500"
					id="practice_email">http://testing.com.pk</div>
				<div class="cnt-left fs-13_ mb-3_ weight_500 tt_uc_"
					id="practice_phone">333-333-3333</div>
			</div>
			...
			<div class="trow_ mb-4_">
				<div class="">
					<div class="">
						...
						<div class="elm-left">
							<!-- <span class="weight_600 mr-4_"> </span> -->
			...
			<!--<div class="trow_ mb-4_">
				<div class="elm-left tt_uc_">sales tax(tx)</div>
				<div class="elm-right wd-70px weight_600 cnt-right pr-3_">$ 0.00</div>
			</div> -->
			<div class="trow_ mb-4_ mb-7_">
				<div class="elm-left tt_uc_ weight_600 pt-4_">amount due</div>
				<div class="elm-right wd-70px weight_600 cnt-right pt-2_ pr-3_"
					style="border-top: solid 1px #242424;" id="rx_sale_2">$ 28.10</div>
			</div>

			<div class="trow_">
				<span class="tt_uc_ mr-4_">items:</span> <span class="tt_uc_"
					id="total_items">1</span>
			</div>
			<!-- <div class="trow_">
				<span class="tt_uc_ mr-4_">clerk id:</span> <span class="tt_uc_ "
					id="clerk_id">c heller</span>
			</div> -->
			<div class="trow_">
			...
			<!--<div class="trow_">
				<span class="weight_600">9424</span>
			</div> -->
			...
			<!--<div class="trow_ mb-14_ cnt-center c-dib_">
				<a class="tt_cc_ p6-12_ bg-wht-txt-blue" href="javascript:void(0);" id="patient_button">Peter Wilson</a>
			</div> -->
		...
		<div class="trow_ mt-14_ cnt-center c-dib_">
                    ...
                    <a class="tt_cc_ p6-12_ txt-white mr-14_ txt-hover-black_24" title="Show Details" href="javascript:void(0);" data-toggle="modal" data-target="#pat_invoice_detail"><span class="fs-24_ fa fa-list-alt"></span></a>
                    <a class="tt_cc_ p6-12_ txt-white mr-14_ txt-hover-black_24" title="Show Drug History" href="javascript:void(0);" onclick="showDrugMessages();"><span class="fs-24_ fa fa-history"></span></a>
		</div>
  						...
  						<div class="trow_ bg-f2f2f2 pa-14_">
                			...
                			<div class="trow_">
                				...
                				<table class="txt-gray-blue bg-transparent wd-100p">
                					...
                					<tr>
                						<td class="cnt-center fs-19_" id="fax_hcp_prescriber">Qamar Jamil Orig
                						</td>
