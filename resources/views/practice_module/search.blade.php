...
<style>
    ...
    .dashboard-info-row { display: flex; justify-content: center; }

    .dashboard-info-row .dashboard-info-box_ { cursor: pointer; margin-right: 34px; display: flex; justify-content: flex-start;
    align-items: center; border: solid 1px rgba(62, 123, 196, 0.6); padding: 6px;}
    .dashboard-info-row .dashboard-info-box_:last-child { margin-right: 0%; }



    .dashboard-info-row .dashboard-info-box_ span.ttile-desc { color: #3e7bc4; }
    .dashboard-info-row .dashboard-info-box_ .paid-count { margin-left: 7px; }

    .dashboard-info-row .dashboard-info-box_:hover {  }
    .dashboard-info-row .dashboard-info-box_:hover span.ttile-desc {  }
    .dashboard-info-row .dashboard-info-box_:hover .paid-count {  }
    ...
    @media only screen and (max-width: 1400px) {
        ...
        .dashboard-info-row { flex-wrap: wrap; }
        		...
        		<div class="flx-justify-start flex-vr-start">
            		<div class="dashboard-info-row bg-f2f2f2 mr-1p" style="flex-grow: 4; padding-top:10px; padding-bottom: 2px;">
            			...
            			<div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=21')}}'">
            				...
            				<span class="ttile-desc weight_600 fs-13_" style="width: 82px;">New HCP Rx's & Patient Msgs</span>
            			...
            			<div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=10')}}'">
            				...
            				<span class="ttile-desc weight_600 fs-13_" style="width: 74px;">Prescriptions Ready for Fill</span>
                        ...
                        <div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=23')}}'">
                            <span class="mr-4_"><img style="width: auto; height: 32px;" src="{{ url('svgs/Prescriptions-Ready-to-fill.svg') }}"></span>
                            <span class="ttile-desc weight_600 fs-13_" style="width: 93px;">Review Patient Requested Refills</span>
            			...
            			<div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=2')}}'">
            				...
            				<span class="ttile-desc weight_600 fs-13_" style="width: 79px;">Patient Follow Up Needed</span>
            			...
            			<div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=24')}}'">
            				...
            				<span class="ttile-desc weight_600 fs-13_" style="width: 83px;">Prescription Waiting Review</span>
            			...
            			<div class="dashboard-info-box_ bg-white br-rds-24 mb-10_ mr-1p_" onclick="window.location='{{url('orders?service=pat&from_date='.\Carbon\Carbon::now()->subDay()->format('m/d/Y').'&to_date='.\Carbon\Carbon::now()->format('m/d/Y'))}}'">
            				...
            				<span class="ttile-desc weight_600 fs-13_" style="width: 76px;">Newly Enrolled Patients Today</span>
                        ...
                        <div class="dashboard-info-box_ bg-white br-rds-24 mb-10_" onclick="window.location='{{url('orders?service=2')}}'">
            				<span class="mr-4_"><img style="width: auto; height: 32px;" src="{{ url('svgs/new-enrolled-patient.svg') }}"></span>
            				<span class="ttile-desc weight_600 fs-13_" style="width: 62px;">ALL Enroller Patients</span>
            				<span class="paid-count ml-auto_ fs-24_ weight_600 txt-red">{{$counts->existing_enrolled?$counts->existing_enrolled:'0'}}</span>
            			</div>
            			--}}
            		</div>
            		<div class="flx-justify-start bg-f2f2f2 pa-4_ flex-vr-center" style="flex-grow: 0; padding-bottom: 0px;">
        				<div class="dashboard-info-box_ bg-f2f2f2 br-rds-24" style="max-width: 310px;">
                    ...
                    <table class="table bordered-hd-blue-shade">
							<thead class="bg-blue">
								<tr class="weight_500-force-childs">
									<th class="txt-wht">Branch Name</th>
							...
							<tbody>
								...
								<tr>
                                    <td>{{ $practice->practice_name }} {{ $practice->branch_name?'( '.$practice->branch_name.' )':'( Main )' }}
