...
<div class="row v-hidden-opacity" id="hidden-opa" >
	<div class="col-sm-12" style="max-width: 1180px; margin: 0px auto; padding-bottom: 100px;">
		...
		<div id="bus-assoc-agrmnts">
            <p class="left-indent-4p">This Business Associate Agreement is executed by and between Compliance Reward, LP. (the "Company") with a principal address of <span class="field-placeholder" style="width: 120px;">{{Auth::user()->name}}</span>, and Representative, an individual ("Business Associate") with a principal address of <span class="field-placeholder" style="width: 270px;">{{Auth::user()->practices->first()->practice_address}}</span> to be effective as of the <span class="field-placeholder" style="width: 30px;">{{date('d')}}</span> day of <span class="field-placeholder" style="width: 20px;">{{date('m')}}</span>, 20<span class="field-placeholder" style="width: 30px;">{{date('y')}}</span> (this "Agreement") and is made a part of that certain Marketing Agency Agreement already entered into by and between these same parties dated as of this same Effective Date (the "Marketing Agency Agreement").</p>
        				...
        				<div class="trow_ bag-field_ by_field_ mb-14_">
        					<label>By:</label>
        					 <div id="signature-pad" class="jay-signature-pad">
                                ...
                                <div class="signature-pad--footer txt-center">                                    <div class="description cnt-left c-dib_ mb-7_"><strong class="fs-17_ weight_600"> Please Sign Above </strong></div>                                    <div class="signature-pad--actions txt-center">
                                <div class="trow_ mb-7_">
