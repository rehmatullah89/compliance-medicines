...
<div class="row v-hidden-opacity" id="hidden-opa" >
	<div class="col-sm-12" style="max-width: 1180px; margin: 0px auto; padding-bottom: 100px;">
		...
		<div id="bus-assoc-agrmnts">
            <p class="left-indent-4p">This Business Associate Agreement is executed by and between Compliance Reward, LP. (the "Company") with a principal address of <span class="field-placeholder" style="width: 120px;">{{Auth::user()->name}}</span>, and Representative, an individual ("Business Associate") with a principal address of <span class="field-placeholder" style="width: 270px;">{{Auth::user()->practice->practice_address}}</span> to be effective as of the <span class="field-placeholder" style="width: 30px;">{{date('d')}}</span> day of <span class="field-placeholder" style="width: 20px;">{{date('m')}}</span>, 20<span class="field-placeholder" style="width: 30px;">{{date('y')}}</span> (this "Agreement") and is made a part of that certain Marketing Agency Agreement already entered into by and between these same parties dated as of this same Effective Date (the "Marketing Agency Agreement").</p>
        ...
        <div class="trow_"> <!-- form -->
            <div id="bus-assoc-agr-form" class="wd-100p mb-24_ flx-justify-start flex-vr-end">
            	...
            	<div class="wd-47p" style="margin-left: auto;">
        			...
        			<div class="trow_ mb-7_">
        				...
        				<p class="trow_ mb-14_ fs-17_">Are you sure you want to apply your electronic signature to this Note? By clicking "Yes", you agree the terms and conditions of this Promissory Note, and this electronic signature will have the same legal efffect as a handwritten signature.</p>
        			</div>
        			
        			<div class="mb-32_" style=" display: flex; align-items: center; margin-right: 24px;">
            ...
            <div class="signature-pad--footer txt-center">
                <div class="description"><strong> Please Sign Above </strong></div>
                <div class="signature-pad--actions txt-center">
                    ...
                    <div>
        				...
        				<div class="trow_ bag-field_ date_field_ mb-14_">
        					<label>Date:</label>
        					<input type="text" disabled="disabled" value="{{date('m/d/Y')}}">
        				</div>
        				...
        				<div class="trow_ bag-field_ title_field_">
        					<label>Title:</label>
        					<input type="text" disabled="disabled" class="cnt-left" @if(isset(auth()->user()->roles[0]->name))
      ...
      <div class="modal-body">
  			<div class="row">
  				<div class="col-sm-12">
  					...
  					<div class="trow_ cnt-center c-dib_ mb-7_"><span class="txt-black-24 weight_900 tt_uc_ fs-24_">please review and sign</span></div>
...
<div class="modal" data-backdrop='static' data-keyboard='false' id="review-confirmation">
  <div class="modal-dialog" style="max-width: 480px;">
    <form class="modal-content">
      ...
      <div class="modal-footer">
      		<div class="flx-justify-center wd-100p pb-14_">
        		<button type="button" class="btn bg-red-txt-wht weight_500 fs-14_ tt_uc_" data-dismiss="modal" style="margin-right: 2.4vw">No</button>
        		<button class="btn bg-blue-txt-wht weight_600 fs-20_ tt_uc_" style="line-height: 20px; padding: .6rem .75rem; margin-left: 2.4vw;" onclick="event.preventDefault();
